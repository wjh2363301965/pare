...
public class RiskConifg {
    ...
    public RiskConifg(RiskSource riskSource) {
    ...
    private void generateInputConfig(StringBuffer sb){
        ...
        sb.append("last_run_metadata_path => \"/opt/logstash-8.7.1/run/my-logstash.yml\"");
        sb.append(lineSeparator);
    ...
    private void generateOutputConfig(StringBuffer sb){
        ...
        sb.append("statement => [ \"INSERT INTO dscg.tbl_dbms_operate_log(user,ip,command,method,event_time,content) VALUES (?,?,?,?,?,?)\",\"[user]\",\"[ip]\",\"[command_type]\",\"[method]\",\"[event_time]\",\"[argument]\" ]");
        sb.append(lineSeparator);
